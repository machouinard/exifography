...
Tags: exif, iptc, photos, photographs, photoblog, metadata
...
Icons for images in plugin directory are Creative Commons:

* [Designed by Freepik and distributed by Flaticon](http://www.flaticon.com/packs/camera-icons)
...
= Why isn’t my EXIF showing? =
There’s a number of reasons why your data might not be showing, please check the following:
1. If you’re using auto-insert, please make sure the image is “attached” to the post (you can check the image attachment in the Media Library list view)
1. Test the EXIF display using the shortcode, including the image ID
1. Make sure the metadata is not being stripped from your image. This can happen when using Save For Web in Photoshop, or when using image compression tools.
1. Check that your server has the PHP Exif module installed, without this WordPress won’t be able to extract the metadata from the image.
